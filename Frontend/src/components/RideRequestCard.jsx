  ...
  return (
    <div className="bg-gray-800 text-white p-6 rounded-xl shadow-lg mb-6 max-w-xl mx-auto border border-gray-700">
      ...
      <div className="space-y-2 text-gray-300">
        <p><strong>Pickup Location:</strong> {pickupLocation?.coordinates?.[1]}, {pickupLocation?.coordinates?.[0]}</p>
        <p><strong>Drop-off Location:</strong> {dropOffLocation?.coordinates?.[1]}, {dropOffLocation?.coordinates?.[0]}</p>
